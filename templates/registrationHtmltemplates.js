export const newRegistrationButtonClick = (details, paymentLink) => {
  return `
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
    <div class="container">
        ...
        <ul>
          ${details.eventIds
            .map(
              (event) => `
          <li>
            ${event.eventName} - ${event.registrationCharge.currency}
      ...
      <div class="payment">
        ...
        <p>
          Payment is pending. Please pay using this link:
...
export const paymentHtml = (details, paymentLink) => {
  const paymentDetails =
    details.paymentStatus === "Completed"
      ...
      : `
        ...
        <p>
          Payment is ${details.paymentStatus} with txnId ${details.paymentId}. Please pay using this link:
          <a href="${paymentLink}">${paymentLink}</a>
        </p>
      `;
